        ...
        try {
            ...
            for (int i = 0; i < rowCount; i++) {
                for (Column c : columns) {
                    ...
                    if (c.getLabel().equals("Available")) {
                        if (c.getValue(i).equals("1")) {
                            System.out.print(String.format(format, "true"));
                        } else if (c.getValue(i).equals("0")) {
                            System.out.print(String.format(format, "false"));
                        } else {
